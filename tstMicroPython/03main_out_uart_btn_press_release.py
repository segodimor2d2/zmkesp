...
# Delay inicial para garantir que o nRF52840 já iniciou
print("Aguardando ZMK...")
time.sleep(2)  # aguarda 2 segundos após boot

print("Pronto para enviar eventos UART.")
    ...
    if estado_atual != estado_anterior:
        ...
        if estado_atual != estado_anterior:
            if estado_atual == 0:
                ...
                uart.write(bytes([0xAA, 0x01, ROW, COL]))  # Press
            else:
                print("Botão SOLTO")
                uart.write(bytes([0xAA, 0x00, ROW, COL]))  # Release
